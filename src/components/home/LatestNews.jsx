...
export default function LatestNews() {
  const posts = [
    {
      id: 1,
      title: 'RCFI Receives CAK Certification for CertySign Platform',
      excerpt: 'CertySign becomes Kenya\'s first locally-hosted digital trust service to receive official certification from the Communications Authority of Kenya.',
