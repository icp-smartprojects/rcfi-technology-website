  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-1/3 -right-10 w-72 h-72 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float animation-delay-300"></div>
        <div className="absolute -bottom-32 left-1/3 w-72 h-72 bg-primary-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float animation-delay-500"></div>
      </div>
