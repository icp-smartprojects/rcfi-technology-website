...
export default function LegalSolution() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-red-50 via-white to-red-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact/demo" className="px-8 py-4 bg-red-600 text-white rounded-lg hover:bg-red-700 font-semibold text-lg transition-all inline-flex items-center justify-center">
                  Request Demo <FiArrowRight className="ml-2" />
                </Link>
                <Link href="/contact" className="px-8 py-4 border-2 border-red-600 text-red-600 rounded-lg hover:bg-red-50 font-semibold text-lg transition-all text-center">
                  Contact Sales
                </Link>
              </div>
            </div>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6 mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="font-bold text-lg text-red-600">Kenya Evidence Act Compliant</div>
                ...
                <div className="bg-gradient-to-br from-red-100 to-red-50 rounded-xl p-12 flex items-center justify-center">
                  <FiShield className="w-48 h-48 text-red-600 opacity-20" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="order-2 lg:order-1 bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl p-12 flex items-center justify-center">
                  <FiFileText className="w-48 h-48 text-blue-600 opacity-20" />
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-6 text-center border-2 border-gray-200">
                <FiAward className="w-8 h-8 text-red-600 mx-auto mb-3" />
      ...
      {/* Final CTA */}
      <section className="py-24 px-4 bg-gradient-to-r from-red-600 to-red-800">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact/demo" className="px-8 py-4 bg-white text-red-600 rounded-lg hover:bg-red-50 font-semibold text-lg transition-all">
              Schedule a Demo
            </Link>
