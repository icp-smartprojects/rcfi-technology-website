    ...
    <>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {study.products.map((product) => (
                        <span key={product} className="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold">
                          {product}
                        </span>
                      ))}
                    </div>
      ...
      <section className="py-24 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <Link href="/contact/demo" className="px-8 py-4 bg-white text-blue-600 rounded-lg hover:bg-blue-50 font-semibold text-lg transition-all inline-block">
            Request a Demo
          </Link>
        </div>
      </section>
