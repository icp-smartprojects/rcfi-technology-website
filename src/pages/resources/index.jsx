            ...
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-primary-600">{category.count}</div>
                </Link>
              )
            })}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featured.map((resource, index) => (
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all">
                ...
                <div className="p-6">
                  <div className="text-sm font-semibold text-primary-600 mb-2">{resource.type}</div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link href={resource.href} className="text-primary-600 font-semibold hover:text-primary-700">
                      Read More →
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-24 px-4 bg-primary-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            />
            <button className="px-8 py-4 bg-white text-primary-600 rounded-lg hover:bg-primary-50 font-semibold transition-all">
              Subscribe
            </button>
          </form>
        </div>
